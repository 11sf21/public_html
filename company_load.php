 ...
 */
 ...
 if (mysqli_connect_errno())
  ...
  die();
   ...
   mysqli_query($cxn,"drop table Dependent;");
   mysqli_query($cxn,"drop table Project;");
   mysqli_query($cxn,"drop table Employee;");
   ...
   mysqli_query($cxn,"CREATE TABLE Employee(
   ...
   mysqli_query($cxn,"CREATE TABLE Project(
   ...
   mysqli_query($cxn,"CREATE TABLE Dependent(
   ...
   mysqli_query($cxn,"CREATE TABLE Works_On(
                  SSN			CHAR(11)	NOT NULL,
                  PNo			INTEGER		NOT NULL,
                  Hours			DECIMAL(5,2),
                  PRIMARY KEY (SSN, PNo));");

   mysqli_query($cxn,"CREATE TABLE DeptLocations(
                  DNo			INTEGER		NOT NULL,
     ...
     mysqli_query($cxn,"insert into Employee values
   ...
   mysqli_query($cxn,"insert into Project values
   ...
   mysqli_query($cxn,"insert into Dependent values
   ...
   mysqli_query($cxn,"insert into Works_On values
         ('123456789',1,32.5),
         ('123456789',2,7.5),
         ('666884444',3,40.0),
         ('453453453',1,20.0),
   ...
   mysqli_query($cxn,"insert into DeptLocations values
         (1,'Houston'),
         (4,'Stafford'),
         (5,'Bellaire'),
         (5,'Sugarland'),
